...
const AdminPlaylistsView = ({role}) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.request({
            ...
            data: {
                name,
                link: `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippetf&playlistId=${link}&maxResults=50&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`,
...
export default AdminPlaylistsView;
